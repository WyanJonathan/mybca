...
class riwayatPage4 extends StatefulWidget {
  const riwayatPage4({super.key});

  @override
  State<riwayatPage4> createState() => _riwayatPage4State();
}

class _riwayatPage4State extends State<riwayatPage4> {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          // change color while the other colors stay the same.
            ...
            title: widgetFont("Riwayat di bulan ${detail['month']}", title4)
        ),
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              Container(
                ...
                child: widgetFont(detail['month'], blue2),
              ),
              Container(
