...
class qrisPagePin extends StatefulWidget {
  const qrisPagePin({super.key, required this.title});

  final String title;
  @override
  State<qrisPagePin> createState() => _qrisPagePinState();
}

class _qrisPagePinState extends State<qrisPagePin> {
